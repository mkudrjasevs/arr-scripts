...
curl https://raw.githubusercontent.com/mkudrjasevs/arr-scripts/main/ra-rom-downloader/Downloader.bash -o /custom-services.d/Downloader
echo "Done"
chmod 777 /custom-services.d/Downloader

if [ ! -f /config/extended.conf ]; then
	echo "Download Extended config..."
	curl https://raw.githubusercontent.com/mkudrjasevs/arr-scripts/main/ra-rom-downloader/extended.conf -o /config/extended.conf
